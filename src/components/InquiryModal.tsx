            ...
            {submitted ? (
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
                  <div className="p-2 rounded-xl bg-white border border-amber-400/80 shadow-[0_0_20px_rgba(245,183,0,0.3)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-mono text-gray-600 uppercase mb-1">Email</label>
                      <div className="relative">
                    ...
                    <div>
                      <label className="block text-xs font-mono text-gray-600 uppercase mb-1">Phone</label>
                      <div className="relative">
                  ...
                  <div>
                    <label className="block text-xs font-mono text-gray-600 uppercase mb-1">Message / Requirements</label>
                    <textarea
                      rows={3}
                  ...
                  <div className="text-center text-[11px] font-mono text-gray-500 pt-1">
                    India: +91-7984171515 • USA: +1-272-267-9294
                  </div>
                </form>
              </div>
