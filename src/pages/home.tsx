  ...
  className="py-24 bg-white border-b border-slate-200 relative">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <motion.div 
            ...
            className="max-w-4xl mx-auto bg-slate-900 border border-slate-800 p-8 sm:p-12 rounded-3xl shadow-2xl text-white relative"
          >
            <div className="grid md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-7 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-serif font-bold text-amber-300">{corridorData[activeCorridor].name}</h3>
              ...
              <div className="md:col-span-5 flex flex-col justify-center space-y-4 bg-slate-950 p-6 rounded-2xl border border-slate-800 text-center">
                ...
                <Button 
                  onClick={() => setInquiryOpen(true)}
                  className="w-full h-11 bg-gradient-to-r from-amber-400 to-yellow-500 hover:brightness-110 text-slate-950 font-bold text-xs uppercase cursor-pointer rounded-xl"
                >
