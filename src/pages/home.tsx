                ...
                <div className="relative glass-card-cyber rounded-3xl p-6 sm:p-8 overflow-hidden group">
                  ...
                  <div className="flex flex-col items-center sm:items-start sm:flex-row sm:justify-between mb-6 pb-6 border-b border-white/10 gap-4">
                    <div className="p-2 rounded-2xl bg-white/95 border-2 border-amber-400/80 shadow-[0_0_25px_rgba(245,183,0,0.4)]">
                      <img src={`${import.meta.env.BASE_URL}logo-transparent.png`} alt="OneTrade360 Logo" className="h-16 sm:h-20 w-auto object-contain max-w-[240px] drop-shadow-[0_0_12px_rgba(255,255,255,0.7)]" />
                    </div>
