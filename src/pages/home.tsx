          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 border border-slate-300 text-slate-800 text-xs font-mono font-semibold uppercase tracking-wider shadow-sm"
              >
              ...
              <h1 className="text-4xl sm:text-6xl xl:text-7xl font-serif font-extrabold text-slate-950 leading-[1.12] tracking-tight">
                The Complete <br />
          ...
          >
            {[
              ...
              return (
                ...
                >
                  <div className="space-y-4">
                    <div className="w-12 h-12 rounded-xl bg-slate-100 border border-slate-200 text-slate-900 flex items-center justify-center shadow-sm">
                      <CardIcon className="w-6 h-6 text-slate-900" />
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/contact">
                <Button variant="outline" className="w-full sm:w-auto h-13 px-8 border-slate-300 text-slate-900 hover:bg-slate-100 font-serif text-xs uppercase cursor-pointer rounded-xl">
