    ...
    <div className="bg-white min-h-screen text-slate-900 font-sans relative selection:bg-amber-400 selection:text-slate-950 overflow-hidden">
      ...
      <section className="relative py-16 border-b border-gray-200 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-400/10 border border-cyan-400/30 text-amber-700 text-xs font-mono font-semibold uppercase tracking-wider mb-6">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 max-w-6xl">
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-white border border-gray-200 shadow-sm rounded-2xl rounded-3xl p-8 space-y-6">
                <h3 className="text-2xl font-serif font-bold text-gray-950 flex items-center gap-2">
                ...
                <div className="space-y-4">
                  {/* India Line */}
                  <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 hover:border-emerald-400/50 transition-colors">
                    <div className="text-xs font-mono text-emerald-400 uppercase tracking-wider mb-1">India Contact Line</div>
                    <div className="text-xl font-bold text-gray-950 font-serif flex items-center gap-3">
                  ...
                  {/* USA Line */}
                  <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 hover:border-cyan-400/50 transition-colors">
                  ...
                  {/* Email */}
                  <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 hover:border-amber-400/50 transition-colors">
                    <div className="text-xs font-mono text-amber-400 uppercase tracking-wider mb-1">Direct Support Email</div>
                    <div className="text-base font-bold text-gray-950 font-mono flex items-center gap-3 truncate">
            ...
            <div className="lg:col-span-7">
              <div className="glass-card-gold rounded-3xl p-8 sm:p-10 relative overflow-hidden">
                <h3 className="text-2xl font-serif font-bold text-gray-950 mb-2">Send an Inquiry</h3>
                ...
                {submitted ? (
                  <div className="py-16 text-center space-y-4">
                    ...
                    <h4 className="text-2xl font-serif font-bold text-gray-950">Inquiry Received Successfully!</h4>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-950 focus:outline-none focus:border-cyan-400 transition-colors"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-sm text-gray-950 focus:outline-none focus:border-cyan-400 transition-colors"
                      />
                    </div>

                    <Button type="submit" className="w-full h-14 bg-gradient-to-r from-amber-400 to-amber-500 text-slate-950 font-bold text-base clip-diagonal shadow-[0_0_25px_rgba(245,183,0,0.35)]">
                      Submit Inquiry Now
