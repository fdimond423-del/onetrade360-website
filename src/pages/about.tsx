      ...
      <section className="py-20 relative border-b border-white/10">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-amber-400/20 border border-amber-400/40 flex items-center justify-center text-amber-400 mb-6">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="glass-card-cyber rounded-3xl p-8 sm:p-10 border border-cyan-400/40 relative overflow-hidden"
            >
              <div className="w-14 h-14 rounded-2xl bg-cyan-400/20 border border-cyan-400/40 flex items-center justify-center text-cyan-400 mb-6">
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {pillars.map((item, idx) => (
              <motion.div
                ...
                className="glass-card p-6 rounded-2xl border border-white/10 hover:border-amber-400/50 transition-all duration-300 group"
              >
          ...
          <div className="mt-16 text-center glass-card-gold rounded-3xl p-10 relative overflow-hidden">
            <h3 className="text-3xl font-serif font-bold text-white mb-4">Everything Your Business Needs. All in One Place.</h3>
