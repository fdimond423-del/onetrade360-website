        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {industries.map((ind, idx) => (
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-amber-50 border border-amber-400/30 flex items-center justify-center text-amber-700 group-hover:bg-gray-950 text-amber-700 group-hover:text-amber-700 transition-colors">
  ...
  className="py-20 relative">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((srv, idx) => (
              ...
              >
                ...
                <h3 className="text-lg font-serif font-bold text-amber-700 mb-2">{srv.title}</h3>
          ...
          <div className="mt-16 text-center glass-card-gold rounded-3xl p-10 relative overflow-hidden">
            <h3 className="text-3xl font-serif font-bold text-amber-700 mb-4">Ready to Source Directly from Verified OEM Factories?</h3>
